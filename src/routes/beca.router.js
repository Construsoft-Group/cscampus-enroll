...
router.get('/form', (req, res) => {res.render("forms/formBeca")});
router.get('/formTest', (req, res) => {res.render("forms/formTest")});
router.get('/success', (req, res) => {res.render("forms/success")});
router.get('/not-success', (req, res) => {res.render("forms/not-success")});
