...
export const customerEnrollmentReq_BIMTC = async (req, res) => {
  ...
  formData.parse(req, async (error, fields) => {
    ...
    const dataResponse = {
      ...
      message: 'Estás a un paso de transformar la manera en que gestionas tus proyectos BIM',
      link: { url: 'https://www.construsoft.es/es/curso-gratis-cde/gracias-por-tu-solicitud', text: 'Accede ahora al curso' }
    };
